...
var $buttons;
var $display;
var currentValue = 0; //camelcasing interger = whole number; float = can contain decimals
var currentOperator = "";
var currentInput = "";
var lastInput = "";
var operators = ["+","-","*","/"];
var lastPress = "";
var hasOperated = false; //boolean = True or False
var hasInput = false;
...
$(document).ready(function() {
	...
	// shorthand: $buttons.click(onButtonClick);
...
function appendInput(input) {
	console.log(hasOperated, hasInput)
